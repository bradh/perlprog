...
export BASE_SCENARIO_DURATION=2880; # in second
...
TEMP_DIR="tmp"
OUTPUT_DIR="scenario"
TEST_NAME="t_c2_capa_unitaire"
TEST_NAME_UMAT="t_c2_capa_unitaire_umat"
TEST_NAME_SIMPLE="t_c2_capa_unitaire_simple"
...
INIT_15_POLYGONES="15_polygones.xhd"
PISTE_PIC_CHARGE="piste_pic_charge.xhd"
DROP_PIC_CHARGE="drop_pic_charge.xhd"
...
echo "Last time :"$LAST_TIME_BEFORE_DROP_IN_HMS
for ext in $DATA_LINK_FILE_EXT ;do 
...
# Demarrage des pistes locales 10s après le début de la réception des pistes remote
# permet de limiter le pic de charge du démarrage !
...
#cat $TEMPLATE_DIR/$INIT_XHD_MSG_FILE_UMAT $TEMPLATE_DIR/$INIT_15_POLYGONES $TEMPLATE_DIR/$PISTE_PIC_CHARGE $TEMPLATE_DIR/$DROP_PIC_CHARGE $TEMP_DIR/tmp41_result.xhd | sort -u > $OUTPUT_DIR/$TEST_NAME_UMAT.xhd
cat $TEMPLATE_DIR/$INIT_XHD_MSG_FILE_UMAT $TEMP_DIR/tmp41_result.xhd | sort -u > $OUTPUT_DIR/$TEST_NAME_UMAT.xhd
#cat $TEMPLATE_DIR/$INIT_XHD_MSG_FILE_SIMPLE $TEMPLATE_DIR/$INIT_15_POLYGONES $TEMPLATE_DIR/$PISTE_PIC_CHARGE $TEMPLATE_DIR/$DROP_PIC_CHARGE $TEMP_DIR/tmp41_result.xhd | sort -u > $OUTPUT_DIR/$TEST_NAME_SIMPLE.xhd
cat $TEMPLATE_DIR/$INIT_XHD_MSG_FILE_SIMPLE $TEMP_DIR/tmp41_result.xhd | sort -u > $OUTPUT_DIR/$TEST_NAME_SIMPLE.xhd
...
./fom2fim.pl -f $OUTPUT_DIR/$TEST_NAME.fom

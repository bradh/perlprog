...
# Definir le repertoire de test 
	...
	$REP_TEST = "$REP_TEST_CONFIG/$VERSION/$NOM_TEST/ATR";
	print "$REP_TEST\n";
...
# Lancement des TD	
	...
	system("xterm -title TI_TEST_DRIVER -geometry 150x40-300+300 -e ./ti_test_driver ti_test_driver.conf $year $month $day $second &")if($opt_i);

package aladdin_AHD106;

my $test = 0;

my $AHD106_v2 = "00:00:00.000 00000061 00000065 0000 0000 0065 0200 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 FFFF FF01 FF01 FF01 FFFF 003F 64";
my $AHD106_v6 = "00:00:00.000 00000071 00000065 0000 0000 0065 0600 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 0000 00FF FFFF 01FF 01FF 01FF FF00 3F64 0000 0000 0000 0000 00";
my $AHD106_ref;
...
my $LTCI_offset = 144;
my $LTCI_length = 8;
my $latitude_offset = 240;
my $latitude_length = 32;
my $longitude_offset = 272;
my $longitude_length = 32;
my $course_offset = 204;
my $course_length = 32;
my $speed_offset = 336;
my $speed_length = 16;
my $tq_offset = 352;
my $tq_length = 8;
my $platform_offset = 504;
my $platform_length = 8;
my $specific_type_offset = 412;
...
sub format_AHD106{
	my $r_AHD106 = shift;
	if($$r_AHD106 =~ /^(\d{2}:\d{2}:\d{2}\.\d{3}) (\w{8}) (\w{8}) (.*$)/){
		my $time = $1;
		my $length = $2;
		my $msg_ID = $3;
		my $msg_data = $4;
		$msg_data =~ s/(\S{4})/$1 /g;
		$$r_AHD106 = "$time $length $msg_ID $msg_data";
	}
}
...
sub setTimetag_Message{
	...
	return -1 if(!defined($r_AHD106));
	if($$r_AHD106 =~ /^(\d{2}:\d{2}:\d{2}\.\d{3}) (\w{8}) (\w{8}) (.*$)/){
		#print "$timetag_msg, $$r_AHD106\n";
		my $time = $1;
		my $length = $2;
		my $msg_ID = $3;
		my $msg_data = $4;
...
sub addTime(){
	my $r_AHD106 = shift;
	my $time = shift;
	$$r_AHD106 =~ s/^(\d{2}:\d{2}:\d{2}\.\d{3})/$time/;
	#print "+time $$r_AHD106\n";
}
...
if($test == 1){
	...
	for my $i (0..90){
		$AHD106 = $AHD106_ref;
		setLatitude(Conversion::latitude2BAM_32($i+0.5), \$AHD106);
		setLongitude(Conversion::longitude2BAM_32($i+0.5), \$AHD106);
		setCourse(Conversion::longitude2BAM_32($i+0.5), \$AHD106);
		#print Fout "$AHD106\n";		
	}
	for my $i (90..180){
		$AHD106 = $AHD106_ref;
		setLatitude(Conversion::latitude2BAM_32(90), \$AHD106);
		setLongitude(Conversion::longitude2BAM_32($i+0.5), \$AHD106);
		setCourse(Conversion::longitude2BAM_32($i+0.5), \$AHD106);
		#print Fout "$AHD106\n";		
	}
	for my $i (0..90){
		$AHD106 = $AHD106_ref;
		setLatitude(Conversion::latitude2BAM_32(-90+0.5), \$AHD106);
		setLongitude(Conversion::longitude2BAM_32(-180+$i+0.5), \$AHD106);
		setCourse(Conversion::longitude2BAM_32(-180+$i+0.5), \$AHD106);
		#print Fout "$AHD106\n";		
	}
	for my $i (90..180){
		$AHD106 = $AHD106_ref;

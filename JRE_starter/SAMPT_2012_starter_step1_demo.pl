...
my $rack_Lynx_IP = "24.1.1.4";
my $synchro_lynx_ok = 1;
my $synchro_sun_ok = -1;

my @TaskList = ("TDL_ROUTER",  "DLIPMNG",
				"JREP", "JREM", "SPYLINKS_JRE" , "TMCT");
...
local $TDL_ROUTER = {	'NUM'		=> $TDL_ROUTER_NUM, 
				...
				'START' 	=> "cd $HOME_DIR/Scripts; ulimit -s unlimited; export TZ=GMT; export Startup_Mode=SY_LIVE; export Startup_State=Active; ./start_DLIP_DEMO >& /dev/null &",
				'STOP' 		=> "cd $HOME_DIR/Scripts; ./stop_DLIP_DEMO >& /dev/null &",
				'CMD' 		=> "cd $HOME_DIR/DLIP_DEMO; ulimit -s unlimited; export TZ=GMT; export Startup_Mode=SY_LIVE; export Startup_State=Active; ./dlip_main >& /dev/null &",
				'LOG' 		=> "dlip_main.log",
				'LOG_DIR' 	=> "$HOME_DIR/DLIP_DEMO",
				'CLEAR_LOG' 	=> "cd $HOME_DIR/Scripts; ./clear_DLIP_DEMO_log",
...
local $JREP = {	'NUM'		=> $JREP_NUM, 
				'EXE' 		=> "./jre_main",
				'RUN_DIR' 	=> "$HOME_DIR/Scripts",
				'START' 	=> "cd $HOME_DIR/Scripts; ulimit -s unlimited; export TZ=GMT; ./start_JREP_DEMO >& /dev/null &",
				'STOP' 		=> "cd $HOME_DIR/Scripts; ./stop_JREP_DEMO >& /dev/null &",
				'CMD' 		=> "cd $HOME_DIR/Scripts; ulimit -s unlimited; export TZ=GMT; ./jre_main >& /dev/null &",
				'LOG' 		=> "jre.log",
				'LOG_DIR' 	=> "$HOME_DIR/JREP_DEMO/trace",
				'CLEAR_LOG' 	=> "cd $HOME_DIR/Scripts; ./clear_JREP_DEMO_log",
				'OPERATING_SYST'	=> "SOLARIS"
};
...
local $JREM = {	'NUM'		=> $JREM_NUM, 
				'EXE' 		=> "launch.bat",
				'RUN_DIR' 	=> "E:\\THALES\\JREM_DEMO\\bin",

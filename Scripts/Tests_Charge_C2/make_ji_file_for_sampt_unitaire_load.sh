...
J2_2_DELTA_TIME=12  # durée pendant laquelle sont émis les J
                    ...
                    # delta_time = REC_RATE 
J2_2_DELTA_NBR=0   # nbre de réccurrence de chaque J
		    # DELTA_NBR * DELTA_TIME = CONSTANTE = 768

################################################
# Parametres  J2.3
################################################
J2_3_NBR=0         # au lieu de 10  
...
J2_3_DELTA_TIME=12  # durée pendant laquelle sont émis les J
                     # chaque message est émis 1 fois
                     # delta_time = REC_RATE 
J2_3_DELTA_NBR=0    # nbre de réccurrence de chaque J
################################################
# Parametres  J2.5
################################################
J2_5_NBR=0          # au lieu de 10
...
J2_5_DELTA_TIME=12  # durée pendant laquelle sont émis les J
                      # chaque message est émis 1 fois
                      # delta_time = REC_RATE 
J2_5_DELTA_NBR=0    # nbre de réccurrence de chaque J
################################################
# Parametres  J3.0
################################################
J3_0_NBR=0          # 10
...
J3_0_DELTA_TIME=768 # durée pendant laquelle sont émis les J
                    # chaque message est émis 1 fois
                    # delta_time = REC_RATE 
J3_0_DELTA_NBR=0   # nbre de réccurrence de chaque J
################################################
# Parametres  J3.2
################################################
J3_2_NBR=5        #
...
J3_6_DELTA_TIME=12  # durée pendant laquelle sont émis les J
                     # chaque message est émis 1 fois
                     # delta_time = REC_RATE 
J3_6_DELTA_NBR=0    # nbre de réccurrence de chaque J
################################################
# Parametres  J3.5
################################################
J3_5_NBR=20         #
...
J3_5_DELTA_TIME=96  # durée pendant laquelle sont émis les J
                    # chaque message est émis 1 fois
                    # delta_time = REC_RATE 
J3_5_DELTA_NBR=0    # nbre de réccurrence de chaque J
################################################
# Parametres  J3.7
################################################
J3_7_NBR=0
...
J3_7_DELTA_TIME=48  # durée pendant laquelle sont émis les J
                    # chaque message est émis 1 fois
                    # delta_time = REC_RATE 
J3_7_DELTA_NBR=0   # nbre de réccurrence de chaque J
...
################################################
print "Make final J7.0 messages drop"
################################################

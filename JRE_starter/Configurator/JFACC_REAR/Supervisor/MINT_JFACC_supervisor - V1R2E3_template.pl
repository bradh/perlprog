...
my $CONFIG_DIR = "$Disk_Label\\CONFIG";
my $RECORDING_DIR = "$Disk_Label\\RECORDING";
my $LOG_DIR = "$Disk_Label\\JFACCLOG";
my $putty_session = "/jfacc";
my $user = "jfacc_op";

my $jrepName;
# Supervision MIDS
#my $mids_db = "MIDS_DB";
my $mids_db = "200.1.18.34";
...
my $linux_ip = "200.1.18.60";
# Supervision cnx DLP
my $dlp_port_num = '1061';

# Supervision cnx JREP
my $jrep_port_num = '2703';

# Supervision cnx HOST
my $host_port_num = '8203';
...
local $DLIP = {	'NUM'		=> $DLIP_NUM, 
				...
				'CONFIG_DIR' 	=> "$HOME_DIR/Ops/DLIP" "				'LOG' 		=> "mct_main.log",

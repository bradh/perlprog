...
# lien vers les fichiers de conf des test driver dans ATP
	system("ln -s ../ATP/$NOM_TEST_MINUS.conf $REP_TEST_ATR/"); 
...
my $InputFile = "$NOM_TEST_MINUS.conf";
...
print Fout "Host_XML_Dictionnary      = /dlip_ref/s_dlip/Tools/Aladdin_V2/v7r0e2_With_Check/Dictionaries/Host/d_sampt_c2_block_v98.xml\n";
close Fout;

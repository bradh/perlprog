...
my $REP_TEST = "/h7_usr/sil2_usr/samptivq/ENDURANCE_SAMPT/TESTS";
...
if ($opt_h) { 
	print "watchNETSTAT.pl [-h] [-r 1(p0) ou 2(p1) ] [-c 1 ou 9] [-v nom_version][-t nom_test]: Affiche periodiquement NETSTAT\n";

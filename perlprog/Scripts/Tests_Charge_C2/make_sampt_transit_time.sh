...
export TEST_TOTAL_DURATION=15 # in minute multiple de BASE_SCENARIO_DURATION
# export BASE_SCENARIO_DURATION=`expr 45 \* 60`; # in second
export BASE_SCENARIO_DURATION=768; # in second
export NB_OF_MIN_RESERVED_TO_DROP_OBJECTS=1 ; # in minute
...
TEMP_DIR="tmp"
OUTPUT_DIR="scenario"
TEST_NAME="t_c2_transit_time"
TEST_NAME_UMAT="t_c2_transit_time_umat"
TEST_NAME_SIMPLE="t_c2_transit_time_simple"
...
cat $TEMPLATE_DIR/$INIT_XHD_MSG_FILE_UMAT $TEMPLATE_DIR/$INIT_XHD_FILTER_FILE $TEMPLATE_DIR/$AHD101_J10_2 $TEMP_DIR/tmp41_result.xhd | sort -u > $OUTPUT_DIR/$TEST_NAME_UMAT.xhd
cat $TEMPLATE_DIR/$INIT_XHD_MSG_FILE_SIMPLE $TEMPLATE_DIR/$INIT_XHD_FILTER_FILE $TEMP_DIR/tmp41_result.xhd | sort -u > $OUTPUT_DIR/$TEST_NAME_SIMPLE.xhd
...
mv $TEMP_DIR/tmp41_result.ji $OUTPUT_DIR/$TEST_NAME.ji

rm -f $TEMP_DIR/tmp41_result.fom
rm -f $TEMP_DIR/tmp41_result.fim

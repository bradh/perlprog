...
export BASE_SCENARIO_DURATION=2700; # in second = 4*BASE_SEQUENCE_DURATION+NB_OFMIN_RESERVER_TO_DROP_OBJECT*60
export NB_OF_MIN_RESERVED_TO_DROP_OBJECTS=3 ; # in minute
export BASE_SEQUENCE_DURATION=768 ; # in second
...
cat $TEMPLATE_DIR/$INIT_XHD_MSG_FILE $TEMPLATE_DIR/$INIT_15_POLYGONES $TEMPLATE_DIR/$PISTE_PIC_CHARGE $TEMPLATE_DIR/$DROP_PIC_CHARGE $TEMP_DIR/tmp41_result.xhd | sort -u > $OUTPUT_DIR/$TEST_NAME.xhd

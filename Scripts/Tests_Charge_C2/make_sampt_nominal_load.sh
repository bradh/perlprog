...
export TEST_TOTAL_DURATION=120;  # in minute multiple de BASE_SCENARIO_DURATION
...
TEMP_DIR="tmp"
OUTPUT_DIR="scenario"
TEST_NAME="t_c2_capa_norm"
TEST_NAME_UMAT="t_c2_capa_norm_umat"
TEST_NAME_SIMPLE="t_c2_capa_norm_simple"

...
my @MOT;
my $RESULTS_FILE = "fom_arrival_times.txt";
...
if( ! $opt_h && $opt_f ) {
	...
	my $fichierOutput = "fom_arrival_times.txt";
	$fichierOutput = "fom_arrival_times_in.txt" if($opt_i);
	$fichierOutput = "fom_arrival_times_out.txt" if($opt_o);

...
AHD109_DELTA_NBR=0  # nbre de réccurrence de chaque AHD10x
...
AHD107_DELTA_TIME=2   # en sec 
		      # durée pendant laquelle sont émis les AHD10x
                      # chaque message est émis 2 fois
                      # delta_time = REC_RATE * 2
AHD107_DELTA_NBR=0  # nbre de réccurrence de chaque AHD10x
		      # DELTA_NBR*DELTA_TIME = CONSTANTE = 768
################################################
# Parametres  AHD101
################################################
...
AHD106_DELTA_TIME=2   # durée pendant laquelle sont émis les AHD10x
                      # chaque message est émis 2 fois
                      # delta_time = REC_RATE * 2
AHD106_DELTA_NBR=0  # nbre de réccurrence de chaque AHD10x
################################################

...
sub updateStatusSIMPLE {	
	if( isSIMPLEPresent()) {
			...
			$startStopButton[$SIMPLE_CNX_NUM]->configure(-background => 'red');
		}
	}
	else {
...
sub updateStatusSIMPLEAT {	
	if( isSIMPLEATPresent()) {
			$startStopButton[$SIMPLE_AT_CNX_NUM]->configure(-background => 'green');
		}
		else {
			$startStopButton[$SIMPLE_AT_CNX_NUM]->configure(-background => 'red');
		}
	}
	else {
		$startStopButton[$SIMPLE_AT_CNX_NUM]->configure(-background => 'grey');
	}
}	

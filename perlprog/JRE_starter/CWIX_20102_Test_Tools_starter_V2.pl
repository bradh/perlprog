...
# Simu L16 (y compris DLTE Simu et DLTE DLIP), L16 TD
...
my @TaskList = ("SIMU_L16", "DLTE_SIMU", "DLTE_DLIP","L16_TD");
...
local $SIMU_L16 = {	'NUM'	=> $SIMU_L16_NUM, 
				'EXE' 		=> "",
				'RUN_DIR' 	=> "/home1/dli",
...
local $DLTE_SIMU = {	'NUM'		=> $DLTE_SIMU_NUM, 
				'EXE' 		=> "launch.bat",
...
local $DLTE_DLIP = {	'NUM'		=> $DLTE_DLIP_NUM, 
				'EXE' 		=> "DLIPCOM.bat",
